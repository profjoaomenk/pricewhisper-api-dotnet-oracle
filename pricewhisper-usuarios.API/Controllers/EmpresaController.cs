...
namespace pricewhisper.Controllers
{
    ...
    public class EmpresaController : ControllerBase
    {
        ...
        private readonly ICNPJaService _cnpjaService; // Alterado para interface

        public EmpresaController(OracleDbContext dbContext, ICNPJaService cnpjaService) // Alterado para interface
        {
            _context = dbContext;
